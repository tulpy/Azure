...
function Export-To-Blob-Storage([string]$resourceGroupName, [string]$AzureFirewallPolicyName, [string]$storageKey, [string]$blobContainerName,$storageContext) {
...
Export-To-Blob-Storage `
	...
	-AzureFirewallName $AzureFirewallPolicyName `
